...
class FloorsControllerTest < ActionController::TestCase
  ...
  test "should create floor" do
    assert_difference('Floor.count') do
      post :create, floor: { building_id: @floor.building_id, description: @floor.description, name: @floor.name }
    end
  ...
  test "should update floor" do
    patch :update, id: @floor, floor: { building_id: @floor.building_id, description: @floor.description, name: @floor.name }
    assert_redirected_to floor_path(assigns(:floor))
  end
