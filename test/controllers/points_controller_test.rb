...
class PointsControllerTest < ActionController::TestCase
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post :create, point: { ox: @point.ox, oy: @point.oy, polygon_id: @point.polygon_id, priority: @point.priority }
    end
  ...
  test "should update point" do
    patch :update, id: @point, point: { ox: @point.ox, oy: @point.oy, polygon_id: @point.polygon_id, priority: @point.priority }
    assert_redirected_to point_path(assigns(:point))
  end
